...
{/* 
        <div className="pointer-events-none mx-auto mt-10 w-full max-w-lg opacity-70">
          <Image
            src="/assets/dist.png"
            alt="Illustration"
            width={800}
            height={480}
            className="mx-auto rounded-xl ring-1 ring-zinc-200/60 dark:ring-zinc-700/50"
          />
        </div> */}
      </section>
    </main>
